...
public class TrelloSteps {
    ...
    public void i_should_see_the_board_created_successfully() {
        Assert.assertTrue("Board creation verification failed", 
            boardPage.isBoardCreated("UI Test Board"));
    }
    ...
    public void i_clean_up_created_board_by_ui() {
        try {
            ...
            Assert.assertTrue("Board was not deleted successfully", 
    ...
    public void listShouldBeCreated(String listName) {
        Assert.assertTrue("List creation verification failed", 
            boardPage.isListCreated(listName));
    }
